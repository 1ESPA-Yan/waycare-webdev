...
function WaycareBottle() {
  ...
  // Todos os dados e ações vêm do contexto global
  const {
    mlGarrafa,
    mlConsumido,
    metaDiaria,
              ...
              <div className="d-flex flex-column gap-1">
                <div className="d-flex align-items-center gap-3">
                  ...
                  <span className="bottle-conectada-badge">
                    <i className="fa-brands fa-bluetooth-b"></i> Conectada
                  </span>
                </div>
                <div className="d-flex align-items-center gap-3">
                  <span className="bottle-status-info"><i className="fa-solid fa-signal"></i> Sensor IoT ativo</span>
                  <span className="bottle-status-info"><i className="fa-solid fa-battery-three-quarters"></i> 87%</span>
                  <span className="bottle-status-info"><i className="fa-solid fa-wifi"></i> Ótimo sinal</span>
                </div>
              </div>
            </div>
            <div className="topbar-actions">
              {/* totalHC vem do contexto — atualiza quando ganha HC */}
              ...
              <div className="col-12 col-xl-5 d-flex flex-column gap-4">
                ...
                <div className="card">
                  ...
                  <div className="d-flex flex-column gap-0">
                    <div className="bottle-info-row"><span className="bottle-info-label"><i className="fa-solid fa-droplet bottle-info-icon--blue-light"></i> Modelo</span><span className="bottle-info-valor">WayCare Bottle Pro</span></div>
                    <div className="bottle-info-divider"></div>
                    <div className="bottle-info-row"><span className="bottle-info-label"><i className="fa-solid fa-rotate bottle-info-icon--gray"></i> Firmware</span><span className="bottle-info-valor">v2.3.1</span></div>
                    <div className="bottle-info-divider"></div>
                    <div className="bottle-info-row"><span className="bottle-info-label"><i className="fa-brands fa-bluetooth-b bottle-info-icon--purple"></i> Bluetooth</span><span className="bottle-info-valor">5.0 LE</span></div>
                    <div className="bottle-info-divider"></div>
                    <div className="bottle-info-row"><span className="bottle-info-label"><i className="fa-solid fa-battery-three-quarters bottle-info-icon--green-light"></i> Bateria</span><span className="bottle-info-valor">87% — ~12 dias</span></div>
                    <div className="bottle-info-divider"></div>
                    <div className="bottle-info-row"><span className="bottle-info-label"><i className="fa-solid fa-wifi bottle-info-icon--green"></i> Conexão</span><span className="bottle-info-valor">Excelente</span></div>
                    <div className="bottle-info-divider"></div>
                    <div className="bottle-info-row"><span className="bottle-info-label"><i className="fa-solid fa-flask bottle-info-icon--blue-light"></i> Capacidade</span><span className="bottle-info-valor">750 ml</span></div>
                  </div>
                  <button className="btn bottle-sync-btn mt-4">
                    <i className="fa-solid fa-rotate"></i> Sincronizar configurações
                  </button>
                </div>

                {/* Meta de Hidratação — clicável */}
                <div className="card">
                  <h3 className="bottle-col-titulo mb-4">
